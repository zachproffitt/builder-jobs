<!--
id: greenhouse-speechify-5976057004
company: Speechify
title: Tech Lead, Web Core Product & Chrome Extension - Tampere, Finland
source: greenhouse
...
url: https://job-boards.greenhouse.io/speechify/jobs/5976057004
summary: Lead development of Speechify's web products and Chrome extension, shipping production code that serves 50M+ users. Drive product decisions on the core web platform while mentoring a distributed team in a flat-structure startup.
skills: JavaScript, React, TypeScript, Redux, Firebase
level: senior
comp: 
comp_extras: 
render_hash: b8cb090f
-->

# Tech Lead, Web Core Product & Chrome Extension - Tampere, Finland

<img src="https://www.google.com/s2/favicons?domain=speechify.com&sz=32" width="16" height="16" align="absmiddle">&ensp;**Speechify**  
Tampere, Finland · `Senior`
...
**[→ Apply](https://job-boards.greenhouse.io/speechify/jobs/5976057004)**
