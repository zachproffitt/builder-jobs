<!--
id: greenhouse-speechify-5974168004
company: Speechify
...
first_seen_at: 
url: https://job-boards.greenhouse.io/speechify/jobs/5974168004
summary: Design and develop robust backend APIs for text-to-speech products including payments, subscriptions, and consumption tracking. Build high-availability services serving 50 million users globally on GCP infrastructure.
skills: TypeScript, Node.js, GCP, Docker, Kubernetes, AWS, PostgreSQL, API Design
level: mid
comp: $140k-$200k
comp_extras: bonus, equity
render_hash: 1a329ff4
-->
...
Salt Lake City, UT, USA · `Mid` · `$140k-$200k` · `Bonus` · `Equity`
...
**[→ Apply](https://job-boards.greenhouse.io/speechify/jobs/5974168004)**
