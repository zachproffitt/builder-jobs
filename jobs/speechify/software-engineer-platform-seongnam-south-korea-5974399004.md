<!--
id: greenhouse-speechify-5974399004
company: Speechify
title: Software Engineer, Platform - Seongnam, South Korea
source: greenhouse
...
url: https://job-boards.greenhouse.io/speechify/jobs/5974399004
summary: Design and develop robust backend APIs for Speechify's text-to-speech platform, including public TTS APIs, payments, subscriptions, and authentication services. Scale systems across GCP to support 50+ million users while collaborating with cross-functional teams on B2B enterprise solutions.
skills: TypeScript, Node.js, GCP, Docker, Kubernetes, AWS, PostgreSQL, API Design
level: mid
comp: 
comp_extras: 
render_hash: 86df95ce
-->
...
**[→ Apply](https://job-boards.greenhouse.io/speechify/jobs/5974399004)**
