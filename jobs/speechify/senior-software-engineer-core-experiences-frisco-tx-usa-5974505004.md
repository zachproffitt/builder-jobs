<!--
id: greenhouse-speechify-5974505004
company: Speechify
title: Senior Software Engineer, Core Experiences - Frisco, TX, USA
source: greenhouse
location: Frisco, TX
...
first_seen_at: 
url: https://job-boards.greenhouse.io/speechify/jobs/5974505004
summary: Build and maintain foundational services and SDKs that power Speechify's cross-platform audio information product. Design end-to-end systems optimizing for fast loading, intelligent parsing, and clear APIs while collaborating with product teams to balance integration tradeoffs.
skills: Kotlin, Kotlin Multiplatform, Java, GCP, Distributed Systems, Cloud Functions, Backend Services
level: senior
comp: $140k-$200k
comp_extras: bonus, equity
render_hash: 7e8b11cd
-->
...
**[→ Apply](https://job-boards.greenhouse.io/speechify/jobs/5974505004)**
