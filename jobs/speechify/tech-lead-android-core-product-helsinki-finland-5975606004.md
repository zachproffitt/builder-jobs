<!--
id: greenhouse-speechify-5975606004
company: Speechify
title: Tech Lead, Android Core Product - Helsinki, Finland
source: greenhouse
...
url: https://job-boards.greenhouse.io/speechify/jobs/5975606004
summary: Lead the Android engineering team to build and scale the most-used text-to-speech app in the Play Store, owning major features and architectural decisions. Drive product quality, reliability, and user experience across a fast-growing mobile platform used by millions globally.
skills: Kotlin, Kotlin Coroutines, Kotlin Flow, Dagger 2, MVVM, Jetpack Compose, Android
level: senior
comp: 
comp_extras: 
render_hash: f6e066f0
-->

# Tech Lead, Android Core Product - Helsinki, Finland

<img src="https://www.google.com/s2/favicons?domain=speechify.com&sz=32" width="16" height="16" align="absmiddle">&ensp;**Speechify**  
Helsinki, Finland · `Senior`
...
**[→ Apply](https://job-boards.greenhouse.io/speechify/jobs/5975606004)**
