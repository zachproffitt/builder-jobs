<!--
id: greenhouse-speechify-5974405004
company: Speechify
title: Software Engineer, Platform - Almaty, Kazakhstan
source: greenhouse
...
url: https://job-boards.greenhouse.io/speechify/jobs/5974405004
summary: Design and develop robust backend APIs including public TTS, payment, subscription, and auth services, maintaining high performance and scalability across GCP and multi-cloud infrastructure. Work on B2B solutions for enterprise clients in a 100% distributed, flat-structure environment where technical excellence directly shapes product strategy.
skills: TypeScript, Node.js, GCP, AWS, Docker, Kubernetes, API Design, Payment Systems
level: mid
comp: 
comp_extras: 
render_hash: f9202586
-->

# Software Engineer, Platform - Almaty, Kazakhstan

<img src="https://www.google.com/s2/favicons?domain=speechify.com&sz=32" width="16" height="16" align="absmiddle">&ensp;**Speechify**  
Almaty, Kazakhstan · `Mid`
...
**[→ Apply](https://job-boards.greenhouse.io/speechify/jobs/5974405004)**
