<!--
id: greenhouse-speechify-5974139004
company: Speechify
title: Software Engineer, Platform - Pasadena, CA, USA
source: greenhouse
...
url: https://job-boards.greenhouse.io/speechify/jobs/5974139004
summary: Design and develop backend APIs for text-to-speech products, including payment, subscription, authentication, and analytics services. Build scalable, high-availability systems serving 50M+ users across web, mobile, and extension platforms.
skills: TypeScript, Node.js, GCP, AWS, Docker, Kubernetes, API Design, PostgreSQL
level: mid
comp: $140k-$200k
comp_extras: bonus, equity
render_hash: 4a57375e
-->
...
Pasadena, CA, USA · `Mid` · `$140k-$200k` · `Bonus` · `Equity`
...
**[→ Apply](https://job-boards.greenhouse.io/speechify/jobs/5974139004)**
