<!--
id: greenhouse-speechify-5974957004
company: Speechify
title: Senior Software Engineer, Windows/Desktop Applications - Manila, Philippines
source: greenhouse
...
url: https://job-boards.greenhouse.io/speechify/jobs/5974957004
summary: Lead the design, architecture, and development of native Windows desktop applications using Windows App SDK, WinUI, and C#, with a focus on accessibility and performance. Drive technical decisions across the Windows platform, mentor engineers, and own features end-to-end from conception through release.
skills: C#, WinUI, Windows App SDK, C++, XAML, Microsoft UI Automation, .NET, Win32/WinRT/COM
level: senior
comp: 
comp_extras: 
render_hash: 8da7a341
-->
...
**[→ Apply](https://job-boards.greenhouse.io/speechify/jobs/5974957004)**
