<!--
id: greenhouse-speechify-5974317004
company: Speechify
title: Software Engineer, Platform - Stockholm, Sweden
source: greenhouse
...
url: https://job-boards.greenhouse.io/speechify/jobs/5974317004
summary: Design and maintain backend APIs for Speechify's text-to-speech platform, including payment, subscription, auth, and consumption tracking systems. Build scalable infrastructure serving 50+ million users across multiple platforms while collaborating on B2B enterprise solutions.
skills: TypeScript, Node.js, GCP, Docker, Kubernetes, AWS, Payment Systems, API Design
level: mid
comp: 
comp_extras: 
render_hash: c37eb923
-->
...
**[→ Apply](https://job-boards.greenhouse.io/speechify/jobs/5974317004)**
