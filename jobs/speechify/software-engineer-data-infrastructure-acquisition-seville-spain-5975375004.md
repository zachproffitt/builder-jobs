<!--
id: greenhouse-speechify-5975375004
company: Speechify
title: Software Engineer, Data Infrastructure & Acquisition - Seville, Spain
source: greenhouse
...
url: https://job-boards.greenhouse.io/speechify/jobs/5975375004
summary: Build and operate petabyte-scale data ingestion pipelines on GCP to collect high-quality audio datasets powering Speechify's text-to-speech models. Work at the intersection of infrastructure engineering, data acquisition, and AI research to optimize the cost/quality/throughput frontier for model training.
skills: Python, Bash, GCP, Terraform, Docker, Web Crawlers, Data Processing Pipelines, Linux
level: senior
comp: 
comp_extras: 
render_hash: b64d4fbb
-->

# Software Engineer, Data Infrastructure & Acquisition - Seville, Spain

<img src="https://www.google.com/s2/favicons?domain=speechify.com&sz=32" width="16" height="16" align="absmiddle">&ensp;**Speechify**  
Seville, Spain · `Senior`
...
**[→ Apply](https://job-boards.greenhouse.io/speechify/jobs/5975375004)**
