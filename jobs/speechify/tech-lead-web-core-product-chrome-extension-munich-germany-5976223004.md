<!--
id: greenhouse-speechify-5976223004
company: Speechify
...
url: https://job-boards.greenhouse.io/speechify/jobs/5976223004
summary: Ship production code and lead web product development for Speechify's text-to-speech platform, building features across iOS, Android, Mac, Chrome Extension, and Web App that serve millions of users. Work directly with product and design teams to shape the roadmap and ship high-impact features in a fast-paced, distributed environment.
skills: React, TypeScript, JavaScript, Firebase, Redux
level: senior
comp: 
comp_extras: 
render_hash: 95eea6db
-->
...
**[→ Apply](https://job-boards.greenhouse.io/speechify/jobs/5976223004)**
