<!--
id: greenhouse-speechify-5974902004
company: Speechify
...
url: https://job-boards.greenhouse.io/speechify/jobs/5974902004
summary: Lead the design and development of native Windows desktop applications using Windows App SDK, WinUI, C#, and XAML for Speechify's text-to-speech platform used by 50+ million people. Ownership spans architecture, accessibility integration, performance optimization, and full feature lifecycle from conception through release.
skills: Windows App SDK, WinUI, C#, XAML, C++, Win32/WinRT/COM, Microsoft UI Automation, .NET
level: senior
comp: 
comp_extras: 
render_hash: a817044d
-->
...
**[→ Apply](https://job-boards.greenhouse.io/speechify/jobs/5974902004)**
