<!--
id: greenhouse-speechify-5975058004
company: Speechify
title: Senior Software Engineer, Windows/Desktop Applications - Ljubljana, Slovenia
source: greenhouse
...
url: https://job-boards.greenhouse.io/speechify/jobs/5975058004
summary: Lead the design, architecture, and development of native Windows desktop applications using Windows App SDK, WinUI, C#, and C++, with a focus on accessibility and performance. You'll own features end-to-end from conception through release and mentor other engineers on Windows best practices.
skills: Windows App SDK, WinUI, C#, XAML, C++, Win32, Microsoft UI Automation, .NET
level: senior
comp: 
comp_extras: 
render_hash: 08978c2b
-->
...
**[→ Apply](https://job-boards.greenhouse.io/speechify/jobs/5975058004)**
