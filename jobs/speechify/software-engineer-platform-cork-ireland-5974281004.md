<!--
id: greenhouse-speechify-5974281004
company: Speechify
title: Software Engineer, Platform - Cork, Ireland
source: greenhouse
...
url: https://job-boards.greenhouse.io/speechify/jobs/5974281004
summary: Design and maintain robust backend APIs including public TTS API, payment, subscription, auth, and consumption tracking services at scale. Build B2B solutions and enterprise integrations while owning the full backend API landscape for a text-to-speech platform used by 50M+ users.
skills: TypeScript, Node.js, GCP, AWS, Docker, Kubernetes, PostgreSQL, REST APIs
level: mid
comp: 
comp_extras: 
render_hash: cbefbdeb
-->

# Software Engineer, Platform - Cork, Ireland
...
**[→ Apply](https://job-boards.greenhouse.io/speechify/jobs/5974281004)**
