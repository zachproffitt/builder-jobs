<!--
id: greenhouse-speechify-5974389004
company: Speechify
title: Software Engineer, Platform - Nagoya, Japan
source: greenhouse
...
url: https://job-boards.greenhouse.io/speechify/jobs/5974389004
summary: Design and maintain backend APIs for text-to-speech products including payments, subscriptions, authentication, and analytics serving 50M+ users. Build high-availability services on cloud infrastructure (GCP/AWS) with focus on performance, scalability, and B2B enterprise integrations.
skills: TypeScript, Node.js, GCP, AWS, Docker, Kubernetes, PostgreSQL, REST APIs
level: mid
comp: 
comp_extras: 
render_hash: d8fed18b
-->

# Software Engineer, Platform - Nagoya, Japan
...
**[→ Apply](https://job-boards.greenhouse.io/speechify/jobs/5974389004)**
