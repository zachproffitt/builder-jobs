...
summary: Develop firmware for AI inference systems optimized for transformer models, focusing on low-level drivers, APIs, and embedded architectures. Implement and troubleshoot firmware across hardware and software stacks for scalable, fault-tolerant AI solutions.
skills: firmware design, I2C, SPI, PCIe, DRAM, embedded architectures
source_hash: c0f8126d
---
