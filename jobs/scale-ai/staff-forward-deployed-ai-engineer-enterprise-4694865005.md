<!--
id: greenhouse-scaleai-4694865005
company: Scale AI
title: Staff Forward Deployed AI Engineer, Enterprise 
source: greenhouse
...
summary: Build and deploy production AI agents and integrations for enterprise customers, architecting multi-agent systems, RAG pipelines, and custom data connectors that solve critical business problems in domains like customer support, due diligence, and healthcare. Work embedded at strategic customer sites to bridge Scale AI's capabilities with enterprise infrastructure, requiring hands-on technical leadership and the ability to rapidly prototype solutions in ambiguous environments.
skills: Python, LangChain, LlamaIndex, AWS, GCP, Azure, Docker, Kubernetes
level: staff
comp: $252,000–$315,000
comp_extras: equity
render_hash: b52af0ba
-->

# Staff Forward Deployed AI Engineer, Enterprise 

<a href="https://scale.com"><img src="https://www.google.com/s2/favicons?domain=scale.com&sz=32" width="16" height="16" align="absmiddle"></a>&ensp;**Scale AI** · San Francisco, California / New York, New York / Seattle, Washington · `Staff` · `$252,000–$315,000` · `Equity`

> Scale AI provides data, evaluations, and outcomes to AI labs, governments, and Fortune 500 companies.

_Build and deploy production AI agents and integrations for enterprise customers, architecting multi-agent systems, RAG pipelines, and custom data connectors that solve critical business problems in domains like customer support, due diligence, and healthcare. Work embedded at strategic customer sites to bridge Scale AI's capabilities with enterprise infrastructure, requiring hands-on technical leadership and the ability to rapidly prototype solutions in ambiguous environments._
...
**[→ Apply](https://job-boards.greenhouse.io/scaleai/jobs/4694865005)**
...
Please reference the job posting's subtitle for where this position will be located. For pay transparency purposes, the base salary range for this full-time position in the locations of San Francisco, New York, Seattle is:$252,000&mdash;$315,000 USDPLEASE NOTE:&nbsp;Our policy requires a 90-day waiting period before reconsidering candidates for the same role. This allows us to ensure a fair and thorough evaluation of all applicants.
