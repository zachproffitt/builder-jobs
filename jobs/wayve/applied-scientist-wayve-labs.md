<!--
id: greenhouse-wayve-8552547002
company: Wayve
title: Applied Scientist, Wayve Labs
source: greenhouse
location: Vancouver, Canada / Sunnyvale, CA
...
first_seen_at: 
url: 
summary: Develop foundation models, world models, and reinforcement learning systems for autonomous driving, including generative simulation, spatial AI, and cross-embodiment robotics. Work on multi-year breakthroughs in embodied AI at the intersection of machine learning, robotics, and real-world deployment at scale.
skills: Python, PyTorch, Foundation Models, Transformers, Diffusion Models, Reinforcement Learning, Computer Vision, Robotics
level: senior
comp: 
comp_extras: equity
render_hash: aefdc08d
-->

# Applied Scientist, Wayve Labs

<a href="https://wayve.ai"><img src="https://www.google.com/s2/favicons?domain=wayve.ai&sz=32" width="16" height="16" align="absmiddle"></a>&ensp;**Wayve** · Vancouver, Canada / Sunnyvale, California · `Senior` · <img src="https://img.shields.io/badge/Hybrid-F59E0B?style=flat-square" align="absmiddle"> · `Equity`
...
**Apply by location:**
- **[Vancouver, Canada →](https://wayve.firststage.co/jobs?gh_jid=8552547002)**
- **[Sunnyvale, CA →](https://wayve.firststage.co/jobs?gh_jid=8552567002)**
