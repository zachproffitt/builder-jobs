<!--
id: greenhouse-wayve-8552567002
company: Wayve
title: Applied Scientist, Wayve Labs
source: greenhouse
location: Sunnyvale, CA / Vancouver, Canada
...
first_seen_at: 
url: 
summary: Develop foundation models, world models, and reinforcement learning systems for autonomous driving embodied AI. Work on multi-year research breakthroughs in geometric understanding, generative modeling, and sim-to-real transfer at the frontier of embodied AI with real-world deployment validation.
skills: PyTorch, Transformers, Diffusion Models, Reinforcement Learning, Computer Vision, SLAM, JAX, FSDP
level: senior
comp: 
comp_extras: equity
render_hash: 758a1c39
-->

# Applied Scientist, Wayve Labs

<a href="https://wayve.ai"><img src="https://www.google.com/s2/favicons?domain=wayve.ai&sz=32" width="16" height="16" align="absmiddle"></a>&ensp;**Wayve** · Sunnyvale, California / Vancouver, Canada · `Senior` · <img src="https://img.shields.io/badge/Hybrid-F59E0B?style=flat-square" align="absmiddle"> · `Equity`
