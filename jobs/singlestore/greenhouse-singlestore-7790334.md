<!--
id: greenhouse-singlestore-7790334
company: SingleStore
...
summary: Design and implement cloud infrastructure capabilities for SingleStore's managed database service, including networking, control plane, and scaling systems running on Kubernetes.
skills: Go, Kubernetes, AWS, Azure, GCP
level: mid
render_hash: bef5add1
-->
...
**[→ Apply](https://job-boards.greenhouse.io/singlestore/jobs/7790334)**
...
Must have experience working with distributed systems and containerized services
Must have experience working with cloud services in major clouds like AWS, Azure &amp; GCP
Good to have experience working with Kubernetes, preferably using Golang.
