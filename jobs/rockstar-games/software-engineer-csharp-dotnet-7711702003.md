<!--
id: greenhouse-rockstargames-7711702003
...
first_seen_at: 2026-05-14T17:12:12+00:00
url: https://job-boards.greenhouse.io/rockstargames/jobs/7711702003
summary: Develop high-volume, highly scalable server-side online services for game franchises including matchmaking, cloud saves, leaderboards, and player inventory systems. Build distributed systems serving millions of concurrent players across console and external clients with expertise in Windows Server, SQL Server, and .NET infrastructure.
skills: C#, C++, .NET, SQL Server, API Design, Distributed Systems, Perforce, Xbox Live
level: mid
comp: $101,100-$134,300
comp_extras: bonus, equity
render_hash: 5885a365
-->
...
<sub>First seen May 14, 2026 at 17:12 UTC</sub>

**[→ Apply](https://job-boards.greenhouse.io/rockstargames/jobs/7711702003)**
...
Rockstar is on the lookout for a passionate Software Engineer who considers software development to be a craft, and&nbsp;possess a passion for solving complex problems at scale.&nbsp;&nbsp;
...
Develop high volume, highly scalable server-side features using Windows Server, SQL server, IIS, .NET, and C#.&nbsp;
...
4+ years of experience developing scalable distributed systems.&nbsp;
