<!--
id: greenhouse-sonyinteractiveentertainmentglobal-5832235004
company: Bend Studio
title: - Programmeur·euse I.A. Senior/AI Programmer
source: greenhouse
...
**[→ Apply](https://job-boards.greenhouse.io/sonyinteractiveentertainmentglobal/jobs/5832235004)**
...
En mai 2021, nous nous sommes lancés dans l'aventure de la création des Studios Haven, avec une petite équipe et de grandes ambitions. Notre objectif était de fonder un studio où nous pourrions développer le genre de jeux que nous avons toujours rêvé de créer – et ceux auxquels nous avons toujours rêvé de jouer.
...
n May 2021, we embarked on a journey to start Haven Studios with a small team and big ambitions. Our goal was to build a studio where we could make the kind of games we’ve always wanted to create – and games we’ve longed to play.
