<!--
id: greenhouse-sonyinteractiveentertainmentglobal-5982700004
company: Bend Studio
...
**[→ Apply](https://job-boards.greenhouse.io/sonyinteractiveentertainmentglobal/jobs/5982700004)**
...
Engage closely with dependent engineering, QA, and operations teams to understand requirements, remove obstacles, and ensure smooth end-to-end delivery.

Monitor and analyze telemetry (metrics, logs, traces) to detect issues, identify improvement opportunities, and drive operational excellence across CI/CD systems and tools.
...
Work across diverse web technology stacks and environments, adapting solutions to multiple platforms and application architectures.
