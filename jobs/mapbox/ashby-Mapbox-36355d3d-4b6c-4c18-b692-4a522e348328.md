...
summary: Build the Android Maps SDK that powers mobile mapping applications across phones, tablets, smartwatches, and embedded devices. Lead large-scale cross-functional projects integrating Navigation, Maps, and Search SDKs while mentoring the team and setting architectural direction.
skills: Kotlin, Java, Android, SDK Design, Performance Optimization, Cross-platform Development
level: senior
comp: 
comp_extras: 
render_hash: 08cde984
-->
