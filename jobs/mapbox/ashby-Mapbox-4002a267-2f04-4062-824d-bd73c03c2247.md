...
summary: Build the Android Maps SDK — a public library powering mobile maps across Android, Flutter, and iOS platforms. Drive architectural direction and large-scale cross-functional projects integrating Navigation, Maps, and Search SDKs while optimizing performance across diverse devices from phones to smartwatches and embedded systems.
skills: Kotlin, Java, Android, SDK Design, Mobile Performance Optimization, Cross-Platform Development
level: senior
comp: 
comp_extras: 
render_hash: dec67c85
-->
