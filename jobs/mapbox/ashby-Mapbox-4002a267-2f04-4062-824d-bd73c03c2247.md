...
summary: Build and maintain the Android Maps SDK, designing expressive APIs and implementing cross-platform features that power navigation and location experiences across mobile devices, wearables, and embedded systems. Lead large-scale architectural initiatives and mentor engineers on a team shipping SDKs used by millions of developers.
skills: Kotlin, Java, Android, Maps SDK, Navigation SDK, Cross-platform Development, Performance Optimization, API Design
level: senior
comp: 
comp_extras: 
render_hash: 5d883ace
-->
