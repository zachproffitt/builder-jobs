<!--
id: greenhouse-bridgebio-5136136007
company: BridgeBio
title: Associate Director, Biostatistics & AI
source: greenhouse
location: Remote - USA
remote: Remote
hybrid: yes
...
url: https://job-boards.greenhouse.io/bridgebio/jobs/5136136007
summary: Design and build AI/ML interfaces embedding large language models, RAG pipelines, and automation tooling into pharmaceutical biometrics workflows—statistical analysis platforms (SAS, R, Python), clinical data repositories, and regulatory submission systems. Establish MLOps infrastructure and governance standards (explainability, bias assessment, 21 CFR Part 11 compliance) in a GxP-regulated environment while delivering high-quality statistical analyses for Phase II–IV clinical trials and regulatory submissions (NDA/BLA/MAA).
skills: SAS, R, Python, LLM APIs, RAG pipelines, MLOps, 21 CFR Part 11, CDISC
level: senior
comp: $173,800-$217,000 USD
comp_extras: equity, bonus
render_hash: 7846216d
-->

# Associate Director, Biostatistics & AI

<img src="https://www.google.com/s2/favicons?domain=bridgebio.com&sz=32" width="16" height="16" align="absmiddle">&ensp;**BridgeBio**  
USA · `Senior` · `Remote` · `$173,800-$217,000 USD` · `Equity` · `Bonus`
...
**[→ Apply](https://job-boards.greenhouse.io/bridgebio/jobs/5136136007)**
...
Salary$173,800&mdash;$217,000 USDAs a global company, our comprehensive benefits may vary based on location.&nbsp; We have high expectations for our team members. We make sure those working hard for patients are rewarded and cared for in return.
