<!--
id: ashby-Supabase-14a99b8b-444b-4d28-b4fd-6fa8e71bcb4e
company: Supabase
...
<a href="https://supabase.com"><img src="https://www.google.com/s2/favicons?domain=supabase.com&sz=32" width="16" height="16" align="absmiddle"></a>&ensp;**Supabase** · `Mid` · <img src="https://img.shields.io/badge/Remote-22C55E?style=flat-square" align="absmiddle"> · `Equity`
...
**[→ Apply](https://jobs.ashbyhq.com/Supabase/14a99b8b-444b-4d28-b4fd-6fa8e71bcb4e)**

---

We are looking for an AI Tooling Engineer with strong expertise in JavaScript/TypeScript to help shape how developers and agents build with Supabase.

As part of our engineering team, you'll work across product surfaces like the dashboard assistant, MCP, docs, and developer tooling to make Supabase a seamless platform for AI-native workflows. You'll combine product thinking, strong engineering fundamentals, and an eval-first mindset to build reliable tools, interfaces, and abstractions that serve both our own AI products and the developers building with Supabase.
