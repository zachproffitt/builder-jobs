...
summary: Own high-speed imaging capability end-to-end for counter-drone and firearms testing, designing test setups, operating Photron Fastcam and Phantom camera systems, and extracting quantitative kinematic data that directly inform mechanical engineering decisions. Work in active test environments with live fire and field testing, delivering clean, defensible data on tight timelines in a mission-critical defense application.
skills: Photron Fastcam, Phantom High-Speed Cameras, ProAnalyst, PFA (Photron FASTCAM Analysis), Motion Analysis, Trigger Circuit Design, Data Acquisition Systems, B.S. in Mechanical Engineering or Physics
level: mid
comp: 
comp_extras: equity
render_hash: e2f1d9fe
-->
