...
summary: Own the high-speed imaging capability end-to-end for counter-drone and firearms systems, designing test setups and extracting quantitative kinematic data that directly informs mechanical engineering decisions. Work in an active test environment with live fire, requiring comfort around firearms and field testing in central Texas conditions.
skills: Photron Fastcam, Phantom cameras, PFA, ProAnalyst, Motion analysis software, Data acquisition systems, Trigger circuit design, Ballistics testing
level: mid
comp: 
comp_extras: equity
render_hash: 10c7cffe
-->

# R&D Test Engineer

<a href="https://9mothers.com"><img src="https://www.google.com/s2/favicons?domain=9mothers.com&sz=32" width="16" height="16" align="absmiddle"></a>&ensp;**9 Mothers** · Austin, TX · `Mid` · On-site · `Equity`
