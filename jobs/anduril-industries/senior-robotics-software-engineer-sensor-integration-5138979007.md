...
summary: Design and deploy software for autonomous robotic systems, integrating sensors, networking, and multi-agent coordination in mission-critical defense applications. Work across the full stack from prototyping to real-world operational deployment, requiring travel up to 25% and hands-on debugging of complex distributed systems.
skills: C++, Rust, LiDAR, ROS, Python, Sensor Fusion, Distributed Systems, TS/SCI Clearance
level: senior
comp: $220k-$292k
comp_extras: equity
...
**[→ Apply](https://boards.greenhouse.io/andurilindustries/jobs/5138979007?gh_jid=5138979007)**
