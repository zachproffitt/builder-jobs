<!--
id: greenhouse-scopely-5200013008
company: Scopely
title: Senior Front End Engineer
source: greenhouse
location: Kelowna, British Columbia, Canada / Remote
remote: Not specified
hybrid: yes
posted_at: Unknown
first_seen: 2026-05-15
first_seen_at: 
url: https://job-boards.greenhouse.io/scopely/jobs/5200013008
summary: Build and improve MONOPOLY GO! Chat features in React Native for a companion app serving millions of players worldwide. Own mobile app performance, testing, and release readiness while adopting AI-assisted development workflows in a fast-moving gaming environment.
skills: React Native, TypeScript, JavaScript, React profiling tools, Xcode Instruments, Android Studio profilers, Swift, Kotlin
level: senior
...
**[→ Apply](https://job-boards.greenhouse.io/scopely/jobs/5200013008)**

---

Scopely is looking for a Senior Front End Engineer to join the MONOPOLY GO! Chat team in Kelowna, British Columbia, Canada, or remotely within Canada and the US.

At Scopely, we care deeply about what we do and want to inspire play, every day - whether in our work environments alongside our talented colleagues, or through our deep connections with our communities of players. We are a global team of game lovers who are developing, publishing, and innovating the mobile games industry, connecting millions of people worldwide every day.

MONOPOLY GO! is a global phenomenon and the biggest mobile game launch in history, captivating millions of players worldwide. MONOPOLY GO! Chat is a companion app that helps players connect, coordinate, and share the fun beyond the game.

&nbsp;

What You Will Do

You will work closely with a small, cross-functional team to build and improve features for the companion app of a game played by millions of players worldwide. You will be responsible for:

Building and improving MONOPOLY GO! Chat features in React Native

Collaborating with product, design, backend, QA, game teams, and other partners to deliver world-class experiences to our players

Owning quality, testing, performance, and release readiness for production mobile app changes

Using generative AI tools such as ChatGPT, Codex, Claude Code, Copilot, and Windsurf for coding, debugging, planning, automation, and documentation

Participating in a strong engineering team and culture through clear communication, ownership, and continuous improvement
...
Experience with the Expo framework for React Native

Experience creating native modules or platform-specific integrations using Java, Kotlin, Objective-C, Swift, or C++

Experience building and maintaining CI/CD pipelines

Experience building and maintaining automations with GitHub Actions or other automation platforms

Experience with the Unity Game Engine and C#
...
We are committed to providing equal employment opportunities and welcome individuals from all backgrounds to join us and embrace the adventure!
...
CA, CO, NJ, NY, and WA Annual Salary Range$107,500&mdash;$212,000 USD&nbsp;
