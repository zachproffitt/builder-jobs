<!--
id: greenhouse-riotgames-7545471
company: Riot Games
...
first_seen_at: 
url: https://www.riotgames.com/en/work-with-us/job/7545471?gh_jid=7545471
summary: Build and evolve scalable backend services and frontend architecture for Riot's content publishing platform that delivers content across game clients, websites, and mobile apps to millions of players. Own the full-stack systems (CMS, microservices, internal tools) that enable content creators to manage and distribute content at global scale across a complex ecosystem.
skills: TypeScript, React, Java, Node.js, CI/CD Pipelines, AWS Lambda, Content Management Systems, Distributed Systems
level: senior
comp: 
comp_extras: 
render_hash: a907eacf
-->
...
**[→ Apply](https://www.riotgames.com/en/work-with-us/job/7545471?gh_jid=7545471)**

---

Riot engineers bring deep knowledge of specific technical areas, but also value the opportunity to work in a variety of broader domains. As Software Engineers, we work with both established and emerging technology, creating innovative solutions to overcome high-volume obstacles and to deliver value to our players.
