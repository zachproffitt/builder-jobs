...
summary: The person will build the AI layer on top of Scribd's Medallion Architecture and Semantic Layer, deploy Databricks Apps infrastructure with guardrails for non-technical users, and develop AI tooling to accelerate the team's development lifecycle.
source_hash: 552f09bf
---
...
> The person will build the AI layer on top of Scribd's Medallion Architecture and Semantic Layer, deploy Databricks Apps infrastructure with guardrails for non-technical users, and develop AI tooling to accelerate the team's development lifecycle.
